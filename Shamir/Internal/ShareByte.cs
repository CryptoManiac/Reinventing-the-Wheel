namespace Wheel.Crypto.Shamir.Internal
{
    internal struct ShareByte
    {
        ...
        #region Precalculated data - Do not edit
        internal static ShareByte[] exponents = [
        ...
        internal static ShareByte[] logs = [
        ...
        public static ShareByte operator *(ShareByte a, ShareByte b)
        {
            ...
            int t = logs[a.value].value + logs[b.value].value;
            if (t > 255)
            {
                t -= 255;
            }
