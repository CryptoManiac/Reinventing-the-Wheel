...
public static partial class ECP
{
    ...
    /// <param name="r"></param>
    /// <param name="sk"></param>
    public static void x25519_BasePointMultiply(Span<U8> r, ReadOnlySpan<U8> sk)
    {
        Ext_POINT S;
    ...
    /// </summary>
    /// <param name="pk">[32-bytes] OUT: Public key</param>
    /// <param name="sk">[32-bytes] IN/OUT: Your secret key</param>
    public static void curve25519_dh_CalculatePublicKey_fast(Span<U8> pk, Span<U8> sk)      
    {
    ...
    /// </summary>
    /// <param name="shared">[32-bytes] OUT: Created shared key</param>
    /// <param name="pk">[32-bytes] IN: Other side's public key</param>
    /// <param name="sk">[32-bytes] IN/OUT: Your secret key</param>
    public static void curve25519_dh_CreateSharedKey(Span<U8> shared, ReadOnlySpan<U8> pk, Span<U8> sk)
    {
        ecp_TrimSecretKey(sk);
