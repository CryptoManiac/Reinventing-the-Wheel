...
internal struct Curve25519Tables
{
    ...
    private unsafe fixed ulong _EC2D_[ModM.ModM_WORDS];
    [FieldOffset(2 * ModM.ModM_WORDS * sizeof(ulong))]
    private unsafe fixed ulong _SqrtNeg1_[ModM.ModM_WORDS];
    [FieldOffset(3 * ModM.ModM_WORDS * sizeof(ulong))]
    private unsafe fixed ulong _BasePoint_[GE25519.TypeUlongSz];
