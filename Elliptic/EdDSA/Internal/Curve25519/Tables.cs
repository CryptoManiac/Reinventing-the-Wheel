...
internal struct Tables
{
    ...
    [FieldOffset((3 * ModM.ModM_WORDS + GE25519.TypeUlongSz + 32 * GE25519_NIELS.TypeUlongSz) * sizeof(ulong))]
    private unsafe fixed byte _NIELS_Base_Multiples_[256 * GE25519_NIELS_Packed.TypeByteSz];
    ...
    private unsafe readonly Span<GE25519_NIELS_Packed> __NIELS_Base_Multiples
    {
        get
        {
            fixed (byte* ptr = &_NIELS_Base_Multiples_[0])
            {
                return new(ptr, 256);
            }
        }
    ...
    private Tables(ReadOnlySpan<ulong> ecd, ReadOnlySpan<ulong> ec2d, ReadOnlySpan<ulong> sqrtNeg1, GE25519 basePoint, ReadOnlySpan<GE25519_NIELS> niels_sliding_multiples, ReadOnlySpan<GE25519_NIELS_Packed> niels_base_multiples)
    {
        ...
        niels_base_multiples.CopyTo(__NIELS_Base_Multiples);
    }
    ...
    public static Tables Get_Tables()
    {
        return new(
            // ECD
            stackalloc ulong[ModM.ModM_WORDS] { 0x00034dca135978a3, 0x0001a8283b156ebd, 0x0005e7a26001c029, 0x000739c663a03cbb, 0x00052036cee2b6ff },
            // EC2D
            stackalloc ulong[ModM.ModM_WORDS] { 0x00069b9426b2f159, 0x00035050762add7a, 0x0003cf44c0038052, 0x0006738cc7407977, 0x0002406d9dc56dff },
            // SqrtNeg1
            stackalloc ulong[ModM.ModM_WORDS] { 0x00061b274a0ea0b0, 0x0000d5a5fc8f189d, 0x0007ef5e9cbd0c60, 0x00078595a6804c9e, 0x0002b8324804fc1d },
            // BasePoint
            stackalloc ulong[GE25519.TypeUlongSz] {
                0x00062d608f25d51a,
                0x000412a4b4f6592a,
                0x00075b7171a4b31d,
                0x0001ff60527118fe,
            ...
            {
                stackalloc ulong[GE25519_NIELS.TypeUlongSz] {
                    0x00003905d740913e,
                    0x0000ba2817d673a2,
                    0x00023e2827f4e67c,
                    0x000133d2e0c21a34,
